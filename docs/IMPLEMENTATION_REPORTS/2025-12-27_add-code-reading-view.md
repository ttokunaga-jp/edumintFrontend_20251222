...
> NOTE: As of 2025-12-31 the per-type View components were consolidated into `NormalSubQuestionView`. The original `CodeReadingView` file has been removed and its functionality unified. This implementation report is kept for historical record.
