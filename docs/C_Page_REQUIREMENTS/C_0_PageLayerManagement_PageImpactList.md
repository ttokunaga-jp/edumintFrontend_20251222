...
- **CreatePage**: [src/pages/CreatePage.tsx](src/pages/CreatePage.tsx) (コントローラ/ビュー分離)
  ...
  - 要確認ファイル: [src/components/page/CreatePage/ProblemCreateView.tsx](src/components/page/CreatePage/ProblemCreateView.tsx)
