...
import { QuestionSectionView } from './QuestionSectionView';
...
const FallbackEdit = ({ questionContent, answerContent, onQuestionChange, onAnswerChange }: ProblemTypeEditProps) => (
    <div >
        <div >専用の編集フォームが未登録です。暫定フォームを使用します。</div>
        <label >問題文</label>
        <textarea
...
export function ProblemEditor({ exam, onChange, canEdit = true }: ProblemEditorProps) {
