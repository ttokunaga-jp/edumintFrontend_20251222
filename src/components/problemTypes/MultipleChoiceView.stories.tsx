...
const meta: Meta<typeof MultipleChoiceView> = {
  title: 'ProblemTypes/MultipleChoiceView',
  component: MultipleChoiceView,
};

export default meta;

type Story = StoryObj<typeof MultipleChoiceView>;
...
export const Default: Story = {
  args: {
    subQuestionNumber: 1,
    questionContent: 'Choose the correct option',
    questionFormat: 0,
    options,
    showAnswer: false,
