...
import type { CreateStep, SourceType, ExerciseOptionsState, DocumentOptionsState,
  ...
  return (
    <div>
      ...
      >
        ...
        {step === 'analysis' && <AnalysisPhase exam={examDraft} onChange={setExamDraft} onBack={backToStart} onNext={goToGeneration} />}
